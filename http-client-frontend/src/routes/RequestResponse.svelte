<script lang="ts">
	...
	function send_request() {
		...
		let url: string = request !== undefined ? request.url : orphan_url;
...
<div class="grid grid-cols-2 min-h-full m-5 overflow-auto">
	<div class="mt-16">
		<div class="input-group input-group-divider grid-cols-[1fr_auto] mb-5">
			...
			{:else}
				<input bind:value={orphan_url} type="text" placeholder="https://example.com/" id="url" />
			{/if}
			<select id="method">

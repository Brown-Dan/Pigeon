...
<div class="grid grid-cols-10 gap-2 h-screen overflow-y-auto">
	<div class="col-span-2 text-left overflow-y-scroll overflow-x-hidden">
		...
		<div class="ml-3 btn-group variant-filled mt-5 hidden lg:inline-block">
			...
			<button on:click={add_request}>
				<svg xmlns="http://www.w3.org/2000/svg" fill="#000000" class="size-6" viewBox="0 0 482.14 482.14"
						 xml:space="preserve">
					<g>
						<path
